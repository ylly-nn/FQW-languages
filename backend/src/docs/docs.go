        ...
        "/language": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Название языка (например, english)",
                        "name": "language",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "ID записи user_languages",
                        "schema": {
                            "$ref": "#/definitions/language.UserLanguageResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request (отсутствует параметр language, язык не найден в справочнике)",
                        "schema": {
                            "type": "string"
                        }
                    },
                    "401": {
                        "description": "Unauthorized (отсутствует или недействителен токен)",
                        "schema": {
                            "type": "string"
                        }
                    },
